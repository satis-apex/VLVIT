                        ...
                        <div class="px-6">
                            ...
                            <div class="text-center mt-12">
                                ...
                                <div class="mb-2 text-slate-600 mt-10">
                                    <i
                                        class="fas fa-briefcase mr-2 text-lg text-slate-400"
                                    ></i>
                                    Solution Manager - Creative Tim Officer
                                </div>
                                <div class="mb-2 text-slate-600">
                                    <i
                                        class="fas fa-university mr-2 text-lg text-slate-400"
                                    ></i>
                                    University of Computer Science
                                </div>
                            </div>
                            <div
                                class="mt-10 py-10 border-t border-slate-200 text-center"
                            >
                                <div class="flex flex-wrap justify-center">
